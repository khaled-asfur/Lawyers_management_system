...
<html>
    ...
    <body dir="rtl">
        ...
        <br><br>
        <h2 class="text-center">القضايا المنتهية </h2>
...
<!-- show  success message end-->
                        ...
                        if($_SERVER["REQUEST_METHOD"]=="POST")
                            {
                                ...
                                if(isset($_POST["all_procecutions"])){
                                    ...
                                    Client::show_all_procecutions($office_id,1);
                                }
        ...
        <!-- show  error message start-->
            <div  style="display:none; margin-left:5%;margin-right:5%;" id="error_dialog_customer"  class="row"><div class="alert alert-danger alert-dismissible show " role="alert">
            <button type="button" class="close"  aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div id="msg_error_dialog_customer"> <!-- the delete error wil be printed here--> </div></div></div>
         <!-- show  error message end-->

         <!-- show  success message start-->
         <div  style="display:none;  margin-left:5%;margin-right:5%;"   id="success_dialog_custmer"  class="row"><div class="alert alert-success alert-dismissible " role="alert">
         <button type="button" class="close"  aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        <!-- show  error message start-->
            <div  style="display:none; margin-left:5%;margin-right:5%;" id="error_dialog_discount"  class="row"><div class="alert alert-danger alert-dismissible show " role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div id="msg_error_dialog_discount"> <!-- the delete error wil be printed here--> </div></div></div>
         <!-- show  error message end-->

         <!-- show  success message start-->
         <div  style="display:none;  margin-left:5%;margin-right:5%;"   id="success_dialog_discount"  class="row"><div class="alert alert-success alert-dismissible " role="alert">
         <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
         ...
         <!-- show  error message start-->
            <div  style="display:none; margin-left:5%;margin-right:5%;" id="error_dialog_agent"  class="row"><div class="alert alert-danger alert-dismissible show " role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div id="msg_error_dialog_agent"> <!-- the delete error wil be printed here--> </div></div></div>
         <!-- show  error message end-->

         <!-- show  success message start-->
         <div  style="display:none;  margin-left:5%;margin-right:5%;"   id="success_dialog_agent"  class="row"><div class="alert alert-success alert-dismissible " role="alert">
         <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        <!-- show  error message start-->
             <div  style="display:none; margin-left:5%;margin-right:5%;" id="error_dialog_procecution"  class="row"><div class="alert alert-danger alert-dismissible show " role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <div id="msg_error_dialog_procecution"> <!-- the delete error wil be printed here--> </div></div></div>
         <!-- show  error message end-->

         <!-- show  success message start-->
         <div  style="display:none;  margin-left:5%;margin-right:5%;"   id="success_dialog_procecution"  class="row"><div class="alert alert-success alert-dismissible " role="alert">
         <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
